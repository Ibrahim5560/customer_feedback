...
export class UsersComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.usersService
      ...
      .subscribe(
        (res: HttpResponse<IUsers[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInUsers(): void {
    this.eventSubscriber = this.eventManager.subscribe('usersListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IUsers[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
