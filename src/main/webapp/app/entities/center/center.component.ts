...
export class CenterComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.centerService
      ...
      .subscribe(
        (res: HttpResponse<ICenter[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCenters(): void {
    this.eventSubscriber = this.eventManager.subscribe('centerListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICenter[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
