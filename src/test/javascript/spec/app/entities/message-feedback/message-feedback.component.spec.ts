...
import { MessageFeedbackComponent } from 'app/entities/message-feedback/message-feedback.component';
...
describe('Component Tests', () => {
  describe('MessageFeedback Management Component', () => {
    let comp: MessageFeedbackComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MessageFeedbackComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.messageFeedbacks && comp.messageFeedbacks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
