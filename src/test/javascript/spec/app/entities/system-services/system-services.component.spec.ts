...
import { SystemServicesComponent } from 'app/entities/system-services/system-services.component';
...
describe('Component Tests', () => {
  describe('SystemServices Management Component', () => {
    let comp: SystemServicesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SystemServicesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.systemServices && comp.systemServices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
