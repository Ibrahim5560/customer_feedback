...
import { SystemComponent } from 'app/entities/system/system.component';
  ...
  describe('System Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SystemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.systems && comp.systems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
